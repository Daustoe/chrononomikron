use super::{BuilderChain, XStart, YStart, StartingPosition, RoomSorter, RoomSort,
    CullUnreachable, BspDungeonBuilder, DistantExit, BspCorridors,
    RoomDrawer, BuilderMap, MetaMapBuilder, DLABuilder, TileType,
    EndingPosition, XEnd, YEnd};
...
pub fn dwarf_fort_builder(new_depth: i32, width: i32, height: i32) -> BuilderChain {
    ...
    chain.with(EndingPosition::new(XEnd::RIGHT, YEnd::BOTTOM));
